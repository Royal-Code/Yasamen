...
- Ausências, divergências e justificativa para seguir.
...
- Definir a rota inicial no docs client.
- Definir a pasta da página em `Pages/Demo/...`.
- Definir o grupo de menu.
- Definir os cenários mínimos do showcase: básico, variações, estados e composição.

## Critérios de Aceite

- [ ] O componente cobre o caso principal previsto no mapa de UI.
...
- [ ] Há showcase no docs client com rota e menu definidos.
