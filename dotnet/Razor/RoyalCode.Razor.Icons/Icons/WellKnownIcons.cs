...
""");
    ...
    /// <summary>
    /// Icon for home / main page.
    /// </summary>
    public static IconFragment Home { get; set; } = NoIconFragment;
    ...
    /// <summary>
    /// Icon for alert state.
    /// </summary>
    public static IconFragment Alert { get; set; } = NoIconFragment;
    ...
    /// <summary>
    /// Icon for highlight state.
    /// </summary>
    public static IconFragment Highlight { get; set; } = NoIconFragment;
    ...
    /// <summary>
    /// Icon for favorite off / not marked as favorite.
    /// </summary>
    public static IconFragment FavoriteOff { get; set; } = NoIconFragment;
