# RoyalCode.Razor - Instruções de Repositório
...
- O tailwindcss tem as classes sobrescritas por `RoyalCode.Razor.Styles/wwwroot/yasamen.css`, use os tokens no padrão do yasamen.css.
