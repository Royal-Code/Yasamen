...
Seu trabalho é manter a qualidade do `RoyalCode.Razor.Docs.Client` como host oficial de demonstrações enquanto `RoyalCode.Razor.Show` ainda não existe como plataforma operacional.
...
- Evite API interna da biblioteca em exemplos de consumidor.
- Quando necessário, crie infraestrutura reutilizável de showcase antes de multiplicar páginas isoladas.
- Use sempre acentuação.

## Saída esperada

- páginas de showcase criadas ou melhoradas;
